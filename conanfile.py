...
class LibVTKConan(ConanFile):
    ...
    def requirements(self):
        ...
        if tools.os_info.is_windows:
            self.requires("libxml2/2.9.8-r4@sight/stable")
            self.requires("expat/2.2.5-r4@sight/stable")
            self.requires("zlib/1.2.11-r4@sight/stable")

        if not tools.os_info.is_linux:
            self.requires("glew/2.0.0-r4@sight/stable")
            ...
            self.requires("libtiff/4.0.9-r4@sight/stable")
